...
<body>
    ...
    <?php
        ...
        $sql="SELECT * FROM aparatos WHERE cod_ap=$cod_ap";
    ...
    <div class="container mt-5">
        <h1 class="text-center">ACTUALIZAR APARATO</h1>
        <form class="formularioInsertar pt-5" action="editar_aparato.php?idEditar=<?php echo $fila['cod_ap'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <td><img style="width:200px" src="data:image/jpg;base64,<?php echo base64_encode($fila['img'])?>" alt="aparato"></td>
            ...
            <a href="aparatos_administrador.php" class="btn btn-info">Volver</a>
        </form>
    </div>
