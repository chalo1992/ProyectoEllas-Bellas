...
<body>
    ...
    <?php
        ...
        $sql="SELECT * FROM tratamientos WHERE cod_trat=$cod_trat";
    ...
    <div class="container mt-5">
        <h1 class="text-center">ACTUALIZAR TRATAMIENTO</h1>
        <form class="formularioInsertar pt-5" action="editar_tratamiento.php?idEditar=<?php echo $fila['cod_trat'] ?>" method="POST" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="number" class="form-control" name="cod_tip" value="<?php echo $fila['cod_tip'] ?>" placeholder="Código tipo">
            </div>
