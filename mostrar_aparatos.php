...
<?php
    ...
    echo "<div class='aparatos-container'>";
        ...
        echo "<h1 class='text-center pt-5 titulo-aparatos'>APARATOS</h1>";

        while ($fila=mysqli_fetch_assoc($resultados)){
            
            echo "<div class='productos mt-5'>";
                echo "<div class='nombre_aparato'>Producto: " . $fila["nombre"] . "</div>";
                echo "<div class='aparato_img'><img src='data:image/jpeg; base64," . base64_encode($fila['img']) . "'></div>";
                echo "<div class='descripcion_aparato'>Descripción: " .$fila["descripcion"] . "</div>";
            echo "</div>";
