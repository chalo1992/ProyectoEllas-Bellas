...
<div class="container-fluid" style="background-color:#D9D2DB;">
    ...
    <div class="contenedorTabla">
        <a href="formAgregar_producto.php" class="btn btn-dark mt-5">Agregar producto</a>
        <hr class="hr">
        <table class="table mt-5">
            ...
            <?php
                ...
                <tr>
                    <th scope="row"><?php $fila['cod_prod'] ?></th>
                    <td><?php echo $fila['nombre'] ?></td>
                    <td style="width:300px"><?php echo $fila['descripcion'] ?></td>
                    <td><?php echo $fila['precio'] ?></td>
                    <td><img style="width:200px; height:200px" src="data:image/jpg;base64,<?php echo base64_encode($fila['img'])?>" alt="producto"></td>
                    <td>
                        <a href="formulario_editar_producto.php?cod_prod=<?php echo $fila['cod_prod']; ?>" class="btn btn-warning">Editar</a>
                        <a href="eliminar_producto.php?cod_prod=<?php echo $fila['cod_prod']; ?>" class="btn btn-danger">Eliminar</a>
                    </td>
                </tr>
