    ...
    <div class="child-page-listing">
        ...
        <div class="grid-container">
          ...
          <article id="3688" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/Tipos/Fotodepilacion/fotodepilacion1.jpeg" alt="Fotodepilación">  </a>
          ...
          <article id="3691" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/Tipos/Faciales/limpieza_facial_aparatologia.jpg" alt="Faciales">  </a>
          ...
          <article id="3694" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/Tipos/Corporales/tratamiento_corporal32.jpg" alt="Corporales">  </a>
          ...
          <article id="3697" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img\FOTOS\Tipos\Cuidado_de_manos_y_pies\manicura_spa.jpg" alt="Cuidado de manos y pies">    </a>
          ...
          <article id="3700" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/Tipos/maquillaje_pestañas/maquillaje1.jpg" alt="Maquillaje y pestañas">          
                </a>
            </div>
          ...
          <article id="3694" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/Tipos/Masajes/masajes11.jpg" alt="Masajes">  </a>
          ...
          <article id="3697" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/ofertas.png" alt="Ofertas especiales">    </a>
          ...
          <article id="3700" class="location-listing">
            ...
            <div class="location-image">
              <a href="#">
                  <img width="300" height="169" src="img/FOTOS/cabina2.jpg" alt="paris">          
                </a>
            </div>
